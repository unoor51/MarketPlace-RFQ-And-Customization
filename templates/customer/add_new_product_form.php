	...
	<form method="POST" id="wpmp-rfq-new-quote-form" class="wpmp-rfq-new-quote-form" action=""
		...
		<table class="form-table wc_status_table widefat">
			<tbody style="border: none;">
				...
				<tr valign="top">
					<td class="forminp" style="display: flex;flex-direction:row;">
				...
				?>
				<tr valign="top">
					<td colspan="2" class="forminp submit-box" style="text-align: right;">
...
<script type="text/javascript">
	 // Add image btn on add RFQ
    jQuery('#wpmp-rfq-form-upload-button').on('click',function(){
	    jQuery('#wpmp-rfq-form-sample-img').click();
	});
</script>